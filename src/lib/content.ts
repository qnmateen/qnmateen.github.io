...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    index: '04',
    phase: 'Frontier',
    kicker: 'Founder · Advisor',
    title: 'Building companies for better health.',
    lede: 'Co-founder and CTO of MindGaps, making mental-health support accessible, and AI Strategy Advisor to Vgenomics on rare-disease genomic diagnostics.',
    accent: '#4ade80',
    stats: [
      { text: 'MindGaps', label: 'Co-founder & CTO' },
      { text: 'Vgenomics', label: 'AI Strategy Advisor' },
      { text: 'AI × Health', label: 'Where I build' },
    ],
    highlights: [
      'MindGaps: co-founder and CTO, making mental-health and psychology support accessible',
